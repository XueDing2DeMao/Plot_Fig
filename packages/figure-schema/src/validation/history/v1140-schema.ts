// 固定 1.14 结构，后续迁移不得使用当前 schema 替代。
export const templateV1140Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.14.0',
  ...
  properties: {
    ...
    schemaVersion: { const: '1.14.0', type: 'string' },
    sharedAxisGroups: {
      items: {
        additionalProperties: false,
        properties: {
...
export const documentV1140Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.14.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
