// 冻结1.19历史结构。
export const templateV1190Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.19.0',
  ...
  properties: {
    ...
    schemaVersion: { const: '1.19.0', type: 'string' },
    sharedAxisGroups: {
      items: {
        additionalProperties: false,
        properties: {
...
export const documentV1190Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.19.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
