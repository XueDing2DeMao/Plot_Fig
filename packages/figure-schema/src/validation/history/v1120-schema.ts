// 固定 1.12 结构，后续迁移不得使用当前 schema 替代。
export const templateV1120Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.12.0',
...
export const documentV1120Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.12.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
