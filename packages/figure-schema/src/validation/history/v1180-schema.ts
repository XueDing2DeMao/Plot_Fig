// 冻结1.18历史结构。
export const templateV1180Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.18.0',
  ...
  properties: {
    ...
    schemaVersion: { const: '1.18.0', type: 'string' },
    sharedAxisGroups: {
      items: {
        additionalProperties: false,
        properties: {
...
export const documentV1180Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.18.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
