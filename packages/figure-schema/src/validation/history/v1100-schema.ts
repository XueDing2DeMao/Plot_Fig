// 冻结的 1.10.0 结构：只用于旧载荷迁移检查，不随当前 schema 演进。
export const templateV1100Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.10.0',
  ...
  properties: {
    ...
    schemaVersion: { const: '1.10.0', type: 'string' },
    sharedAxisGroups: {
      items: {
        additionalProperties: false,
        properties: {
...
export const documentV1100Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.10.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
