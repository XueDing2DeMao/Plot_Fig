// 冻结的 1.8.0 结构，禁止随当前协议改写。
export const templateV180Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.8.0',
...
export const documentV180Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.8.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
