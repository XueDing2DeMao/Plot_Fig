// 冻结的 1.11.0 结构，历史迁移不能引用当前 schema。
export const templateV1110Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.11.0',
  ...
  properties: {
    ...
    schemaVersion: { const: '1.11.0', type: 'string' },
    sharedAxisGroups: {
      items: {
        additionalProperties: false,
        properties: {
...
export const documentV1110Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.11.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
