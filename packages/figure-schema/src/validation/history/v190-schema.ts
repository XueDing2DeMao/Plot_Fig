// 冻结的 1.9.0 结构，仅用于迁移入口。
export const templateV190Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.9.0',
...
export const documentV190Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.9.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
