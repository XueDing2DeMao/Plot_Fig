// 冻结的 1.7.0 结构；由升级前的 schema 产物生成，禁止随当前协议改写。

export const templateV170Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.7.0',
  ...
  properties: {
    ...
    schemaVersion: { const: '1.7.0', type: 'string' },
    sharedAxisGroups: {
      items: {
        additionalProperties: false,
        properties: {
...
export const documentV170Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.7.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
