// 固定 1.15 结构；历史迁移不得引用当前可变 Schema。
export const templateV1150Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.15.0',
  ...
  properties: {
    ...
    schemaVersion: { const: '1.15.0', type: 'string' },
    sharedAxisGroups: {
      items: {
        additionalProperties: false,
        properties: {
...
export const documentV1150Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.15.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
