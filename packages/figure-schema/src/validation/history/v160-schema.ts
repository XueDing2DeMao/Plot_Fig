// 冻结的 1.6.0 结构；由升级前的 schema 产物生成，禁止随当前协议改写。

export const templateV160Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.6.0',
        ...
        properties: {
          ...
          role: {
            anyOf: [
              ...
              {
                const: 'valueErrorLower',
                type: 'string',
              },
              {
                const: 'valueErrorUpper',
                type: 'string',
              },
              {
                const: 'category',
                      ...
                      properties: {
                        ...
                        mode: {
                          anyOf: [
                            ...
                            {
                              const: 'fixed-min-normal',
                              type: 'string',
                            },
                            {
                              const: 'fixed-min-auto',
                              type: 'string',
                            },
                            {
                              const: 'fixed-max-normal',
                              type: 'string',
                            },
                            {
                              const: 'fixed-max-auto',
                              type: 'string',
                            },
                          ],
                        },
...
export const documentV160Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.6.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
