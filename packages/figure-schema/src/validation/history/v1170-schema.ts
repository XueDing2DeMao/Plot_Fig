// 固定1.17历史结构，后续迁移不能引用当前Schema。
export const templateV1170Schema = {
  $id: 'https://plot-fig.dev/schema/figure-template/1.17.0',
  ...
  properties: {
    ...
    schemaVersion: { const: '1.17.0', type: 'string' },
    sharedAxisGroups: {
      items: {
        additionalProperties: false,
        properties: {
...
export const documentV1170Schema = {
  $id: 'https://plot-fig.dev/schema/figure-document/1.17.0',
  $schema: 'https://json-schema.org/draft/2020-12/schema',
  additionalProperties: false,
  properties: {
    bindingSet: {
